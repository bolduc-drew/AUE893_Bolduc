...
class turtlebot_laser:
    ...
    def turn_then_go_to_pos(self, pos_x=0.0, pos_y=0.0, tol_distance=0.01):
    ...
    def duck(self, turn_left=True, angle=20, distance=1.2):
        ...
        self.turn_then_go_to_pos(desired_x, desired_y)
    ...
    def move_to_goal(self, pos_x=0.0, pos_y=0.0, tol_distance=0.05):
        ...
        while not rospy.is_shutdown():
            if self.Flag_duck:
                ...
                self.turn_then_go_to_pos(pos_x, pos_y, tol_distance)
