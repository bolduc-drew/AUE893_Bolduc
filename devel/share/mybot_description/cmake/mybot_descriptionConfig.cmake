...
if("TRUE" STREQUAL "TRUE")
  set(mybot_description_SOURCE_PREFIX /home/bolduc/AUE893_Bolduc/src/mybot_description)
  set(mybot_description_DEVEL_PREFIX /home/bolduc/AUE893_Bolduc/devel)
  ...
  set(mybot_description_INSTALL_PREFIX /home/bolduc/AUE893_Bolduc/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'mybot_description' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'bolduc <bolduc@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'mybot_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bolduc/AUE893_Bolduc/src/mybot_description/${idir}'.  Ask the maintainer 'bolduc <bolduc@todo.todo>' to fix it.")
    endif()
