...
if("TRUE" STREQUAL "TRUE")
  set(driver_base_SOURCE_PREFIX /home/bolduc/AUE893_Bolduc/src/driver_common/driver_base)
  set(driver_base_DEVEL_PREFIX /home/bolduc/AUE893_Bolduc/devel)
  ...
  set(driver_base_INSTALL_PREFIX /home/bolduc/AUE893_Bolduc/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'driver_base' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'bolduc <bolduc@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'driver_base' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bolduc/AUE893_Bolduc/src/driver_common/driver_base/${idir}'.  Ask the maintainer 'bolduc <bolduc@todo.todo>' to fix it.")
    endif()
