...
if("TRUE" STREQUAL "TRUE")
  set(timestamp_tools_SOURCE_PREFIX /home/bolduc/AUE893_Bolduc/src/driver_common/timestamp_tools)
  set(timestamp_tools_DEVEL_PREFIX /home/bolduc/AUE893_Bolduc/devel)
  ...
  set(timestamp_tools_INSTALL_PREFIX /home/bolduc/AUE893_Bolduc/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'timestamp_tools' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'bolduc <bolduc@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'timestamp_tools' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bolduc/AUE893_Bolduc/src/driver_common/timestamp_tools/${idir}'.  Ask the maintainer 'bolduc <bolduc@todo.todo>' to fix it.")
    endif()
